...
{
	pointer = new Sprite(GetPos(), Vector2(30, 150), NULL, L"C:\\Users\\mBorchert\\Desktop\\dsf.bmp");
	pointer->Hide();

	background = new Sprite(Vector2(pos.x, pos.y), Vector2(scale.x, scale.y), NULL, L"C:\\Users\\mBorchert\\Desktop\\dsf.bmp");
	background->Hide();
}
